    ...
    nodes: [
      {
        ...
        data: {
          type: TYPE_MAP.Song,
          imageURL:
            'https://images.unsplash.com/photo-1519139116361-2ea84d04a4aa?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60',
      ...
      },
      {
        ...
        data: {
          ...
          imageURL:
            'https://images.unsplash.com/photo-1519683109079-d5f539e1542f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60'
        }
      }
    ],
...
export default ({skipLoadingScreen}: Props) => <AppContainer />
