...
export const ValueBox = (props: ValueBoxProps) => {
  const {isMulti, onEvent, value, isAdditional, extended, state, setState} = props
  return (
    <>
        ...
        >
          ...
          <Box style={{width: ICON_SIZE}}>
            {isMulti && (
              ...
              >
                <Icon name="close" style={{fontSize: ICON_SIZE}} />
              </IconButton>
            )}
            {isMulti && !isAdditional && (
              <>
                ...
                >
                  <Icon name="arrow_drop_up_rounded" style={{fontSize: ICON_SIZE}} />
                </IconButton>
                <IconButton
                  onClick={() =>
                    onEvent({
                  ...
                  sx={{width: ICON_SIZE, height: ICON_SIZE}}
                >
                  <Icon name="arrow_drop_down_rounded" style={{fontSize: ICON_SIZE}} />
                </IconButton>
              </>
            )}
          </Box>
