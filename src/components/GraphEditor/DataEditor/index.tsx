...
import {Container, List, ListItem, Divider, BoxProps} from '@mui/material'
import * as R from 'colay/ramda'
import {EVENT, ELEMENT_DATA_FIELDS} from '@constants'
import {NewTripleItem} from './NewTripleItem'
import {TripleItem, EventType} from './TripleItem'
import {DataForm} from './DataForm'

export type DataEditorProps = {
  style?: BoxProps['style']
  data: DataItem[]
  onEvent: (param: {type: EventType; payload: any; index?: number; item?: DataItem}) => void
...
export const DataEditorElement = (props: DataEditorProps) => {
  const {data, onEvent, localLabel, globalLabel, isGlobalLabelFirst} = props
  return (
