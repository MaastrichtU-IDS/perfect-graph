...
import {Container as PIXIReactContainer, PixiComponent} from '@inlet/react-pixi'
import {PIXIBasicProps, PIXIDisplayObjectProps, PropsWithRef} from '@type'
import {applyDefaultProps, getEventClientPosition, preprocessProps} from '@utils'
import {Position} from 'colay-ui/type'
import {Enumerable} from 'colay/type'
import * as PIXI from 'pixi.js'
import React from 'react'

export type ContainerProps = PIXIBasicProps &
...
type ContainerPropsWithRef = PropsWithRef<PIXI.Container, ContainerProps>
 ...
 */
// @ts-ignore
export const Container = PixiComponent<ContainerProps, PIXI.Container>('PIXIContainer', {
  create: props => {
    const {onDrag, draggable = false, interactive = false} = props
